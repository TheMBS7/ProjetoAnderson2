...
namespace ProjetoAnderson2.Controllers
{
    public class ContatosController : Controller
    {
        ...
        public ContatosController(LocadoraContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Contato != null ? 
                          ...
                          Problem("Entity set 'LocadoraContext.Contato'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Nome,Assunto,Mensagem")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Nome,Assunto,Mensagem")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LocadoraContext.Contato'  is null.");
            }
            var contato = await _context.Contato.FindAsync(id);
            if (contato != null)
            {
