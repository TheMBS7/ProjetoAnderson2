...
namespace ProjetoAnderson2.Controllers
{
    public class GenerosController : Controller
    {
        ...
        public GenerosController(LocadoraContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genero != null ? 
                          ...
                          Problem("Entity set 'ProjetoAnderson2Context.Genero'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjetoAnderson2Context.Genero'  is null.");
            }
            var genero = await _context.Genero.FindAsync(id);
            if (genero != null)
            {
